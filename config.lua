Config = {}
Config.RequiredCopsRob = 0 -- Gereken Polis Sayısı
Config.MarkerDisctances = 3
Config.InfoTime = 5000 --ms
Config.LocationTime = 15000

--Fiyatlar
Config.CardPrice = 100
Config.PhonePrice = 100
Config.UsbPrice = 100
Config.RewardPrice = 10000

Config.Size         = {x = 0.5, y = 0.5, z = 0.2}
Config.Color       =  {r = 222, g = 18, b = 18}
Config.Type         = 27

Config.Start = {
    { x = -1053.0, y = -232.61, z = 43.22}
}
Config.Card = {
    { x = 779.28, y = -1263.54, z = 26.39}
}

Config.Usb = {
    { x = 457.88, y = -1498.06, z = 28.19}
}

Config.Phone = {
    { x = 50.08, y = -1453.74, z = 29.31}
}

Config.Locations = {  
    {x= 52.22, y = -1449.82, z = 29.31, h=123.87}  
}
...
Config.Time = 50 -- hack işlemi için verilen süre
...
Config.ATM = {
    ...
    {id = 277, x = 315.13, y = -593.76, z = 43.28},
    {id = 277, x = -284.037, y = 6224.385, z = 31.187},
